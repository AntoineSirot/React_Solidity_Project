...
function FakeNefturians() {
  ...
  const [address, setAddress] = useState("0xe955d8fb68cBc901ADb384E5C3920e5a77672977");
  ...
  async function buyToken() {
    ...
    const price = await contract.methods.buyAToken().send({from : accounts[0], value : 100000000000000010})
  ...
  function getTokenDetail() {
    window.open('/fakeNefturians/' + address, "_self")
  }
